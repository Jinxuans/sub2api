export default {
  ...
  payment: {
    title: 'Recharge / Subscription',
    purchaseHeroTitle: 'Subscription Plans',
    currentUserEmail: 'Current user email',
    currentBalanceLabel: 'Account balance',
    pageDescription: 'Choose a balance top-up or subscription plan and complete payment, with subscriptions and recent orders always visible on the side.',
    purchaseNotes: 'Payment Notes',
    purchaseNotesFallback: 'The same plan extends time, while different plans take effect together.\nRefunds are supported by day after purchase.\nA 2% handling fee is charged for refunds.',
    accountOverview: 'Account Overview',
    accountCenter: 'Account Center',
    accountLabel: 'ACCOUNT',
    plansLabel: 'PLANS',
    plansTitle: 'Plan Purchase',
    orderSummary: 'Order Summary',
    selectedPlan: 'Selected Plan',
    choosePlanHint: 'Choose a plan to confirm payment on the right.',
    ...
    rechargeIntro: 'Top-up Info',
    topUpByAmount: 'Top Up by Amount',
    topUpDescription: 'Purchase by recharge amount, and credited balance will be converted by the current rate.',
    exchangeRateLabel: 'Current Rate',
    actualCreditLabel: 'Credited Balance',
    paymentRangeHint: 'Payment amount range is {min} - {max} CNY, increasing by 1 CNY.',
    searchOrdersPlaceholder: 'Search orders',
    topUpNow: 'Top Up Now',
    balanceOrderTitle: 'Balance Top-up ¥{amount} · Credit ${credited}',
    subscriptionOrderTitle: 'Subscription ¥{amount}',
    noSubscriptionForFilter: 'No subscriptions match this filter',
    noPlansBadge: 'No Plans',
    noPlansTitle: 'No plans available right now',
    noPlansDescription: 'Please wait for new subscription plans.',
