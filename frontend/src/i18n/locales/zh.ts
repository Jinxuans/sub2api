export default {
  ...
  payment: {
    title: '充值/订阅',
    purchaseHeroTitle: '订阅套餐购买',
    currentUserEmail: '当前登录用户邮箱',
    currentBalanceLabel: '账户余额',
    pageDescription: '选择充值或订阅套餐并完成支付，右侧可随时查看当前订阅与最近订单。',
    purchaseNotes: '支付说明',
    purchaseNotesFallback: '相同套餐延长时间，不同套餐同时生效。\n购买后支持按天退款，退款时请提供账号和订单号。\n退款统一收取 2% 手续费。',
    ...
    orderSummary: '订单摘要',
    selectedPlan: '已选套餐',
    choosePlanHint: '选择套餐后即可在右侧确认支付',
    recentOrders: '最近订单',
    noRecentOrders: '暂无最近订单',
    viewAllSubscriptions: '查看全部订阅',
    ...
    rechargeIntro: '充值说明',
    topUpByAmount: '按量充值',
    topUpDescription: '按充值金额购买，到账额度会按当前比例自动换算',
    exchangeRateLabel: '当前比例',
    actualCreditLabel: '实际到账',
    paymentRangeHint: '支付金额范围为 {min} - {max} 元，按 1 元递增',
    searchOrdersPlaceholder: '搜索订单名称',
    topUpNow: '立即充值',
    balanceOrderTitle: '余额充值 ¥{amount} · 到账 ${credited}',
    subscriptionOrderTitle: '订阅套餐 ¥{amount}',
    noSubscriptionForFilter: '当前没有匹配的订阅',
    noPlansBadge: '暂无套餐',
    noPlansTitle: '当前暂无可用套餐',
    noPlansDescription: '等待上架新的订阅计划',
    quickAmounts: '快捷金额',
    customAmount: '自定义金额',
    enterAmount: '输入金额',
    paymentMethod: '支付方式',
